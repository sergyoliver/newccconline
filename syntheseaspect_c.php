    ...
    <div class="main-bar row">
        <div class="col-sm-5 col-lg-6 skin_txt">
            <h4 class="nav_top_align">
                <i class="fa fa-pencil"></i>Synthèse Aspect des fruits de cacao collectées par campagne  N-1 et  N
            </h4>
        </div>
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Synthèse Aspect des fruits de cacao collectées par campagne  N-1 et  N </li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-white">
                        Synthèse des fruits de Cacao collectés par campagne  N-1 et  N
                    </div>
...
<script type="text/javascript" >
    ...
    function affiche_comptagecafe() {
        ...
        xhr2.open('POST', "data/syntheseaspect_cacao.php", true);
