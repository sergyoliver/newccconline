    ...
    <div class="main-bar row">
        <div class="col-sm-5 col-lg-6 skin_txt">
            <h4 class="nav_top_align">
                <i class="fa fa-pencil"></i>Synthèse des fruits collectées par campagne  N-1 et  N
            </h4>
        </div>
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Synthèse des fruits collectées par campagne  N-1 et  N </li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-white">
                        Synthèse des fruits de Café collectés par campagne  N-1 et  N
                    </div>
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="periode" id="periode" >
                                            <option selected disabled>selectionner periode</option>
                                ...
                                <div class="col-lg-2 input_field_sections">
                                    <h5>&nbsp;</h5>
                                    <div class="input-group">
                                        <a href="javascript:void (0)" class="btn btn-primary"  name="ok" onclick="affiche_comptagecafe()">
                ...
                <div class="card-block" id="retour_table"></div>
                <div class="card-block" id="retour_table2"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" >
    ...
    function affiche_comptagecafe() {
        ...
        form_data2.append("p", $('#periode').val());


        if (window.XMLHttpRequest) xhr2 = new XMLHttpRequest();
        else if (window.ActiveXObject) xhr2 = new ActiveXObject('Microsoft.XMLHTTP');
        xhr2.open('POST', "data/synthesecafe.php", true);
        xhr2.send(form_data2);
        xhr2.onreadystatechange = function() {
            if (xhr2.readyState == 4 && xhr2.status == 200) {
                document.getElementById("retour_table").innerHTML ='<span style="font-size: 16px; color: red">Patientez SVP...</span>';
                document.getElementById("retour_table").innerHTML = this.responseText;
                affiche_comptage2($('#camp').val(),$('#periode').val());
    ...
    function affiche_comptage2(camp,per) {
        //il fait la mise a jour du prix de base et l'observation
        ...
        form_data2.append("p", per);


        if (window.XMLHttpRequest) xhr2 = new XMLHttpRequest();
        else if (window.ActiveXObject) xhr2 = new ActiveXObject('Microsoft.XMLHTTP');
        xhr2.open('POST', "data/synthesek2.php", true);
        xhr2.send(form_data2);
        xhr2.onreadystatechange = function() {
            if (xhr2.readyState == 4 && xhr2.status == 200) {
                document.getElementById("retour_table2").innerHTML ='<span style="font-size: 16px; color: red">Patientez SVP...</span>';
                document.getElementById("retour_table2").innerHTML = this.responseText;
