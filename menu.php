<nav class="navbar navbar-static-top">
    <div class="container-fluid">
        <a class="navbar-brand text-xs-center" href="accueil.php?page=milieu">
            ...
            <div class="btn-group">
                ...
                <div class="user-settings no-bg">
                    ...
                    <div class="dropdown-menu admire_admin">
                        ...
                        <a class="dropdown-item" href="?page=synthesecafe#"><i class="fa fa-database"></i>
                            Synthèse des fruits Café</a>
                        <a class="dropdown-item" href="?page=synthesecacacao"><i class="fa fa-database"></i>
                            Synthèse des fruits cacao</a>

                        <a class="dropdown-item" href="?page=syntheseaspect_c"><i class="fa fa-database"></i>
                            Synthèse aspects des fruits cacao</a>
                            <a class="dropdown-item" href="?page=syntheseverif_c"><i class="fa fa-database"></i>
                            Vérification des comptages des parcelles de cacao </a>
                        <a class="dropdown-item" href="?page=estimation_par_campagne"><i class="fa fa-database"></i>
                            Estimation des comptages des parcelles de cacao </a>
            ...
            <div class="btn-group">
                ...
                <div class="user-settings no-bg">
                    ...
                    <div class="dropdown-menu admire_admin">
                        ...
                        <a class="dropdown-item" href="?page=lpassage"><i class="fa fa-home"></i>
                            Gestion des passages</a>
