    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Comptage Cacao</li>
            </ol>
        </div>
    </div>
</header>
                                ...
                                <div class="col-lg-2 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="passage" id="passage" >
                                            ...
                                            <?php
                                            $i=1;
                                            $rsp = $bdd->prepare("select * from tb_passage WHERE type_pied='K' ORDER BY id ASC ");
                                            $rsp->execute();
...
<script type="text/javascript" >
    function check_parcelle(str) {
        ...
        xhr2.open('POST', "data/rechparcelle2.php", true);
    ...
    function affiche_comptage() {
        ...
        xhr2.open('POST', "data/rechcomptage.php", true);
        xhr2.send(form_data2);
        xhr2.onreadystatechange = function() {
            if (xhr2.readyState == 4 && xhr2.status == 200) {
