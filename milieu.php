...
<?php
// nbre de departement
$rsd = $bdd->prepare('select * from tb_departement ');
$rsd->execute();
$nbd = $rsd->rowCount();
...
?>
                    <div class="row" >
                        <div class="col-lg-12 input_field_sections" >
                            ...
                            <?php
                            // nbre de departement
                            $rsp = $bdd->prepare('select * from tb_parcelle WHERE supp =0 or supp is null');
                            $rsp->execute();
                            $nbp = $rsp->rowCount();
                        ...
                        <?php
                        // nbre de departement
                        $rssup = $bdd->prepare('select sum(superficie ) as sup from tb_parcelle WHERE supp =0 or supp is null');
                        $rssup->execute();
                        $rowsup = $rssup->fetch();
